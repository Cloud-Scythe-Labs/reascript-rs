...
let
  url_for_platform = version: arch: if stdenv.isDarwin
    then "https://www.reaper.fm/files/7.x/reaper722_universal.dmg"
    else "https://www.reaper.fm/files/7.x/reaper722_linux_x86_64.tar.xz";
in
stdenv.mkDerivation rec {
  ...
  '' else ''
    ...
    wrapProgram $out/opt/REAPER/reaper       --prefix LD_LIBRARY_PATH : "${lib.makeLibraryPath [ curl lame libxml2 ffmpeg vlc xdotool stdenv.cc.cc.lib ]}"
